	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				Lokasi
				<small>Tempat Inventory anda</small>
			</h1>
			<ol class="breadcrumb">
		...
		<section class="content">
			...
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">Tambah lokasi
					</h3>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<form action="<?php echo base_url('locations/add') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('code')) {
															echo "has-error";
														} ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-8 <?php if (form_error('photo')) {
															echo "has-error";
														} ?>">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Daftar Lokasi
					</h3>

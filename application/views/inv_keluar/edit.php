        ...
        <div class="box">
            ...
            <div class="box-body" id="edit_data">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <form id="input_form" action="<?php echo base_url('inv_keluar/edit/') . $code ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
                        <h3>Basic Info</h3>
                        <fieldset>
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="brand" id="brand" class="form-control required 
										<?php if (form_error('brand')) {
                                            echo "error";
                                        } ?>" value="<?php echo $curr_brand ?>" required readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="model" id="model" class="form-control 
										<?php if (form_error('model')) {
                                            echo "error";
                                        } ?>" value="<?php echo $curr_model ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="serial_number" id="serial_number" class="form-control 
										<?php if (form_error('serial_number')) {
                                            echo "error";
                                        } ?>" value="<?php echo $curr_serial_number ?>" readonly>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">

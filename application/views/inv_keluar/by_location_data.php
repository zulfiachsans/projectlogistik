	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url("inv_keluar/all") ?>"><i class="fa fa-archive"></i> Inventory Keluar</a></li>
				<li><a href="<?php echo base_url("inv_keluar/by_location"); ?>">Lokasi</a></li>
		...
		<section class="content">
			...
			<div class="box box-primary">
				...
				<div class="box-footer text-center">
					<?php echo $pagination; ?>
					<br>
					<a href="<?php echo base_url('inv_keluar/by_location'); ?>" class="btn btn-primary">Kembali ke Inventory Keluar menurut Lokasi</a>

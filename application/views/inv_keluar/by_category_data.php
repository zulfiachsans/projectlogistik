	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo base_url("inv_keluar/by_category"); ?>">Kategori</a></li>
		...
		<section class="content">
			...
			<div class="box box-primary">
				...
				<div class="box-footer text-center">
					<?php echo $pagination; ?>
					<br>
					<a href="<?php echo base_url('inv_keluar/by_category'); ?>" class="btn btn-primary">Kembali Berdasarkan Kategori</a>

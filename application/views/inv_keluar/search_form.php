	                                ...
	                                <?php if (count($results->result()) > 0) : ?>
	                                    <?php foreach ($results->result() as $result) : ?>
	                                        <tr>
	                                            ...
	                                            <td width="15%">
	                                                <form action="<?php echo base_url('inve_keluar/delete/' . $result->code) ?>" method="post" autocomplete="off">
	                                                    <div class="btn-group-vertical">
	                                                        <a class="btn btn-sm btn-default" href="<?php echo base_url('inv_keluar/detail/' . $result->code) ?>" role="button"><i class="fa fa-eye"></i> Detail</a>
	                                                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('inv_keluar/edit/' . $result->code) ?>" role="button"><i class="fa fa-pencil"></i> Edit</a>

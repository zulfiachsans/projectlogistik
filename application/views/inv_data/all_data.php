											...
											<td width="15%" align="center">
												<form action="<?php echo base_url('inventory/delete/' . $data->code) ?>" method="post" autocomplete="off">
													<div class="btn-group-vertical">
														...
														<a class="btn btn-sm btn-default btn-pindahkan" href="#" role="button" data-id="<?= $data->id ?>" data-code="<?= $data->code ?>" data-brand="<?= $data->brand ?>" data-jumlah_datas="<?= $data->jumlah_datas ?>" data-status="<?= $data->status ?>" data-created="<?= $data->created_on ?>">
